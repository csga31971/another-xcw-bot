...
CHARA_NAME = {
    ...
    1013: ["七七香", "ナナカ", "Nanaka", "娜娜卡", "77k", "77香", "77"],
    ...
    1036: ["镜华", "キョウカ", "Kyouka", "小仓唯", "xcw", "小苍唯", "8岁", "八岁", "喷水萝", "八岁喷水萝", "8岁喷水萝", "52918"],
    1037: ["智", "トモ", "Tomo", "卜毛"],
    ...
    1058: ["贪吃佩可", "ペコリーヌ", "Pecoriinu", "佩可莉姆", "吃货", "佩可", "公主", "饭团", "🍙", "peko"],
    1059: ["可可萝", "コッコロ", "Kokkoro", "可可罗", "妈", "普白"],
    1060: ["凯留", "キャル", "Kyaru", "凯露", "希留耶", "Kiruya", "黑猫", "臭鼬", "普黑", "凯留"],
    1061: ["矛依未", "ムイミ", "Muimi", "诺维姆", "Noemu", "夏娜", "511", "无意义", "天楼霸断剑"],

    1063: ["亚里莎", "アリサ", "Arisa", "鸭梨瞎", "瞎子", "亚里沙", "鸭梨傻", "亚丽莎", "亚莉莎", "瞎子弓", "🍐🦐", "yls"],

    1065: ["嘉夜", "カヤ", "Kaya", "憨憨龙", "🐲👊🏻", "🐉👊🏻", "龙拳", "笨比"],
    1066: ["祈梨", "イノリ", "Inori", "梨老八", "李老八", "老八"],
    1067: ["穗希", "ホマレ", "Homare"],
    ...
    1073: ["拉基拉基", "ラジニカーント", "Rajinigaanto", "跳跃王", "Rajiraji", "Lajilaji", "垃圾垃圾", "教授", "垃圾"],
    ...
    1104: ["真琴(夏日)", "マコト(サマー)", "Makoto(Summer)", "水狼", "水浪", "浪", "水🐺", "泳狼", "泳月", "泳月月", "泳朋", "水月", "水月月", "水朋", "👙🐺"],
    ...
    1110: ["优妮", "ユニ", "Yuni", "u2", "优妮辈先", "辈先", "书记","油腻"],
    ...
    1128: ["真阳(游骑兵)", "マヒル(レンジャー)", "Mahiru(Ranger)", "骑兵奶牛", "游侠奶牛", "游骑兵奶牛", "护林员奶牛", "护林奶牛", "游侠🐄", "游侠🐮", "牛叉"],
    1129: ["璃乃(奇境)", "リノ(ワンダー)", "Rino(Wonder)", "璃乃(仙境)", "爽弓", "爱丽丝弓", "爱弓", "兔弓", "奇境妹弓", "仙境妹弓", "白丝妹弓", "爱丽丝妹弓"],
    1130: ["步未(奇境)", "アユミ(ワンダー)", "Ayumi(Wonder)", "步未(仙境)", "路人兔", "兔人妹", "爱丽丝路人", "奇境路人", "仙境路人"],
    1131: ["流夏(夏日)", "ルカ(サマー)", "Ruka(Summer)", "水流夏", "水大姐头", "水大姐", "泳装大姐头", "泳装流夏","流夏(泳装)","水流"],
    1132: ["杏奈(夏日)", "アンナ(サマー)", "Anna(Summer)", "水中二", "泳装中二", "冲二", "喷水龙王"],
    1133: ["七七香(夏日)", "ナナカ(サマー)", "Nanaka(Summer)", "水娜娜卡", "水77k", "水77香", "水77"],
    1134: ["初音(夏日)", "ハツネ(サマー)", "Hatsune(Summer)", "水星法", "水星星法", "水法", "水睡法","泳装星法", "泳装星星法", "泳装法", "泳装睡法", "水初音", "泳装初音", "水星", "海星"],
    1135: ["美里(夏日)", "ミサト(サマー)", "Misato(Summer)", "水圣母", "泳装圣母", "水美里", "泳装美里"],
    1136: ["纯(夏日)", "ジュン(サマー)", "Jun(Summer)", "水黑骑"],
    1137: ["茜里(天使)", "アカリ(エンジェル)", "天使妹法"],
    1138: ["依里(天使)", "ヨリ(エンジェル)", "天使姐法"],
    1139: ["纺希(万圣节)", "ツムギ(ハロウィン)", "Tsumugi(Halloween)", "万圣裁缝", "鬼裁", "万圣🕷️", "万圣🕸️", "鬼🕷️", "鬼🕸️"],
    1140: ["怜(万圣节)", "レイ(ハロウィン)", "Rei(Halloween)", "鬼剑圣", "鬼剑"],
    1141: ["茉莉(万圣节)", "マツリ(ハロウィン)", "Matsuri(Halloween)", "万圣跳跳虎", "万圣老虎", "万圣虎", "万圣🐅"],
    1142: ["莫妮卡(魔法少女)", "モニカ(マジカル)", "Monika(MagiGirl)", "魔法毛二力", "魔二力"],
    ...
    1802: ['优衣(公主)', "ユイ(プリンセス)", "Yui(Princess)", "公主种田", "公主优衣", "掉毛", "飞翼", "飞翼高达", "公田", "飞田"],
    ...
    1999: ["啪啪啪213", "您啪2", "作死", "作哥", "啪总","papapa","啪啪啪","papapa213"]
}
