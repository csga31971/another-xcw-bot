...
async def voice_guess(bot, ev: CQEvent):
    ...
    with gm.start_game(ev.group_id) as game:
        ...
        await asyncio.sleep(ONE_TURN_TIME+10)
        # 结算
        if game.winner:
            return
        c = chara.fromid(game.answer)
